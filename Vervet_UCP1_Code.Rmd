...
samtools faidx Vervet_UCP1.fasta #index fasta file

git clone https://github.com/broadinstitute/picard.git
java -jar build/libs/picard.jar
java -jar picard.jar CreateSequenceDictionary REFERENCE=Vervet_UCP1.fasta OUTPUT=Vervet_UCP1.dict #create dictionary file

for word in $(cat pyg.samples.list)
do
tabix -p vcf $word.vcf.gz #generate index file
done


#failed attempts to troubleshoot
...
#Auctual Code for GATK

for word in $(cat pyg.samples.list)
do
gatk FastaAlternateReferenceMaker -R Vervet_UCP1.fasta -O $word.fasta -V $word.vcf.gz
done

gatk FastaAlternateReferenceMaker -R Vervet_UCP1.fasta -O VSAA2010.fasta -V VSAA2010.vcf.gz
...
ALL <- read.vcfR("pyg_UCP1.vcf.gz", verbose = TRUE)
