...
```{bash}
tabix -h  163_201701_UG_vervet_monkey_SNPs_all_chrom_beagle_shapeit.vcf.gz CAE7:87492140-87502530 | bgzip -c > ALL_UPC1.vcf.gz
vcf-subset -c pyg.samples.list ALL_UPC1.vcf.gz | bgzip  -c > pyg_UCP1.vcf.gz
zgrep -v "^##" pyg_UCP1.vcf.gz | cut -f1-3 > loci.txt 
```
